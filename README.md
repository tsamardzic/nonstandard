...
Source: Einar Haugen (1966), [Dialect, Language, Nation](https://anthrosource.onlinelibrary.wiley.com/share/VHDXIIS4K43WSXKETNBW?target=10.1525/aa.1966.68.4.02a00040), American Anthropologist. 

---
### 2. Good and bad sides of language standardisation


<a href="https://youtu.be/fS4X1JfX6_Q"><img src="figures/oknotok-video.png" alt="oknotok" width="570"/>

Source: [Gretchen McCulloch Resources](https://gretchenmcculloch.com/resources/)
...
|:--------|--|:----------|:---------------| 
| __Good__  |    | Broader unity | Expressiveness  |  
|           |   | clarity       | fun |
|           |   | easy to process| local identity | 
| __Bad__   |   | Pressure on minorities |  Hard to process |
|           |   | flatness       | hard to process !! |
|           |   | hard to maintain | hard to process !!! | 
